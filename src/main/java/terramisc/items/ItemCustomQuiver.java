...
public class ItemCustomQuiver extends ItemQuiver
{
	...
	{	
		...
		for(ItemStack i : inventory)
		{
			...
			else if(i!=null && i.getItem() == TFCMItems.itemArrow_Copper)
			{
				return arrowTier = 2;
			}
			else if(i!=null && i.getItem() == TFCMItems.itemArrow_BismuthBronze)
			{
				return arrowTier = 3;
			}
			else if(i!=null && i.getItem() == TFCMItems.itemArrow_Bronze)
			{
				return arrowTier = 4;
			}
			else if(i!=null && i.getItem() == TFCMItems.itemArrow_BlackBronze)
			{
				return arrowTier = 5;
			}
			else if(i!=null && i.getItem() == TFCMItems.itemArrow_WroughtIron)
			{
				return arrowTier = 6;
			}
			else if(i!=null && i.getItem() == TFCMItems.itemArrow_Steel)
			{
				return arrowTier = 7;
			}
			else if(i!=null && i.getItem() == TFCMItems.itemArrow_BlackSteel)
			{
				return arrowTier = 8;
			}
			else if(i!=null && i.getItem() == TFCMItems.itemArrow_BlueSteel)
			{
				return arrowTier = 9;
			}
			else if(i!=null && i.getItem() == TFCMItems.itemArrow_RedSteel)
			{
				return arrowTier = 10;
			}	
	...
	{	
		...
		for(ItemStack i : inventory)
		{
			...
			if(i!=null && i.getItem() == TFCMItems.itemBolt_Copper)
			{
				return boltTier = 1;
			}
			else if(i!=null && i.getItem() == TFCMItems.itemBolt_BismuthBronze)
			{
				return boltTier = 2;
			}
			else if(i!=null && i.getItem() == TFCMItems.itemBolt_Bronze)
			{
				return boltTier = 3;
			}
			else if(i!=null && i.getItem() == TFCMItems.itemBolt_BlackBronze)
			{
				return boltTier = 4;
			}
			else if(i!=null && i.getItem() == TFCMItems.itemBolt_WroughtIron)
			{
				return boltTier = 5;
			}
			else if(i!=null && i.getItem() == TFCMItems.itemBolt_Steel)
			{
				return boltTier = 6;
			}
			else if(i!=null && i.getItem() == TFCMItems.itemBolt_BlackSteel)
			{
				return boltTier = 7;
			}
			else if(i!=null && i.getItem() == TFCMItems.itemBolt_BlueSteel)
			{
				return boltTier = 8;
			}
			else if(i!=null && i.getItem() == TFCMItems.itemBolt_RedSteel)
			{
				return boltTier = 9;
			}	
	...
	public void addInformation(ItemStack is, EntityPlayer player, List arraylist, boolean flag)
	{
		...
		if (TFC_Core.showShiftInformation())
		{
			...
			arraylist.add(EnumChatFormatting.ITALIC + TFC_Core.translate("Bolts") + ": " + EnumChatFormatting.YELLOW + getQuiverMetalBolts(is));
