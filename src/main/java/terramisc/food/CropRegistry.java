...
public class CropRegistry 
{
	...
	public static void registerCrops() 
	{
		...
		manager.addIndex(new CropIndexTFCM("coffee", 1, 90, 6, 19, 14, TFCMItems.seedsCoffee, true, 0.3f).setOutput1(TFCMItems.coffee, 4.0f));
		...
		manager.addIndex(new CropIndexTFCM("sweetPotato", 2, 32, 6, 4, 0, TFCMItems.seedsSweetPotato, true, 0.9f).setOutput1(TFCMItems.sweetPotato, 50.0f));
