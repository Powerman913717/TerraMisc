...
public class CropRegistry 
{
	...
	public static void registerCrops() 
	{
		...
		manager.addIndex(new CropIndexTFCM("pumpkin", 2, 48, 6, 10, 3, TFCMItems.seedsPumpkin, false, 0.7f).setOutput1(TFCMItems.pumpkin, 32.0f));
		...
		manager.addIndex(new CropIndexTFCM("watermelon", 2, 20, 6, 15, 10, TFCMItems.seedsWatermelon, true, 1.0f).setOutput1(TFCMItems.watermelon, 25.0f));
